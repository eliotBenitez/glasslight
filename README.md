...
геометрии Spotlight; снаружи остаётся только компактная самостоятельная тень,
...
параметрами продолжаются внутри той же строки Spotlight: Enter подтверждает
...
Закрытие и повторное открытие Spotlight её не очищают. Сохраняется до 20 записей
...
не добавляется обратно при открытии Spotlight. Повторное копирование того же
